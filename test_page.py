...
class test_buildScreen(QMainWindow):#might just need to be empty.
    def __init__(self, Main_Page_Widget,factory_serial):
        ...
        self.mainTest_scrollArea = QtWidgets.QScrollArea(self.test_central_widget)
        self.mainTest_scrollArea.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.mainTest_scrollArea.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.mainTest_scrollArea.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.mainTest_scrollArea.setFrameShadow(QtWidgets.QFrame.Plain)
        self.mainTest_scrollArea.setWidgetResizable(False)
        ...
        self.test_scrollArea = QtWidgets.QScrollArea()
        self.test_scrollArea.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.test_scrollArea.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.test_scrollArea.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.test_scrollArea.setFrameShadow(QtWidgets.QFrame.Plain)
        self.test_scrollArea.setWidgetResizable(True)

        cable_data_frame = self.create_square_frame(length=200,height=200)
        self.get_all_cable_data_btn = QtWidgets.QPushButton(cable_data_frame)
        self.get_all_cable_data_btn.setText("Get All Cable Data")
        self.get_all_cable_data_btn.setGeometry(0, 0, 110, 35)
        # self.get_all_cable_data_btn.setFont(self.font(10, 10,False ))
        ...
        self.temps_btn = QtWidgets.QPushButton(temps_frame)
        self.temps_btn.setText("Temps")
        self.temps_btn.setFont(self.font(10,10,True))
        self.temps_btn.setGeometry(0,0,100,35)
        ...
        self.get_cal_data = QtWidgets.QPushButton(cal_data_frame)
        self.get_cal_data.setText("Get Cal Data")
        self.get_cal_data.setGeometry(0,0,110,35)
        self.get_cal_data.setFont(self.font(10,10,True))
